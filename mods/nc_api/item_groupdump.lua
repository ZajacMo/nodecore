...
local groups = {
	...
	nc_concrete_etched = "any non-pliant concrete node with etched patterns",
	nc_concrete_pattern_bindy = "any type of concrete with a bindy pattern",
	nc_concrete_pattern_boxy = "any type of concrete with a boxy pattern",
	nc_concrete_pattern_bricky = "any type of concrete with a bricky pattern",
	nc_concrete_pattern_hashy = "any type of concrete with a hashy pattern",
	nc_concrete_pattern_horzy = "any type of concrete with a horzy pattern",
	nc_concrete_pattern_iceboxy = "any type of concrete with a iceboxy pattern",
	nc_concrete_pattern_vermy = "any type of concrete with a vermy pattern",
	nc_concrete_pattern_verty = "any type of concrete with a verty pattern",
	nc_concrete_pliant = "any type of concrete in a pliant state",
